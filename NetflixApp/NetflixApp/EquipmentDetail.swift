...
struct EquipmentDetail: View {
    ...
    var body: some View {
        ...
        GeometryReader { geo in
            ...
            SynopsisView(isSet:  $modelData.equipment[equipmentIndex].isFavorite, equipment: equipment)
        }
            ...
            .onAppear() {
                ...
                AVPlayer(url: URL(string: equipment.videourl)!).play()
            }
            .onDisappear {
                AVPlayer(url: URL(string: equipment.videourl)!).pause()
            }
    }
...
struct player : UIViewControllerRepresentable {
    ...
    func makeUIViewController(context: UIViewControllerRepresentableContext<player>) -> AVPlayerViewController {
        ...
        let player1 = AVPlayer(url: URL(string: equipment.videourl)!)
